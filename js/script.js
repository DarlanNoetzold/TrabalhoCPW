...
btnNotAl.onclick = function () {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        for (var i = 1; i <= 10; i++) {
            txt = txt + "<tr><td>Aluno " + i + "</td><td>" + prova1[i] + "</td><td>" + prova2[i] + "</td><td>" + prova3[i] + "</td><td>" + (((prova1[i] + prova2[i] + prova3[i]) / 3).toFixed(2)) + "</td></tr>";
        }
        txt = txt + "</table><br>";
    }
...
btnNotProf.onclick = function () {
    ...
    var prova1i = parseFloat(document.querySelector("#prova1i").value);
    var prova2i = parseFloat(document.querySelector("#prova2i").value);
    var prova3i = parseFloat(document.querySelector("#prova3i").value);
    prova1[i] = prova1i;
    prova2[i] = prova2i;
    prova3[i] = prova3i;
    return false;
